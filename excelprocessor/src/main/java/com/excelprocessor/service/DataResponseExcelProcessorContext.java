...
public class DataResponseExcelProcessorContext extends ExcelProcessorContext {
    ...
    public DataResponseExcelProcessorContext(String campaignID, String requestID) {
